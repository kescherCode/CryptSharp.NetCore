...
public static class Base32Encoding
{
    ...
    {
        Crockford = new("0123456789ABCDEFGHJKMNPQRSTVWXYZ", false,
            new Dictionary<char, int> { { 'O', 0 }, { 'I', 1 }, { 'L', 1 }, { 'U', 27 } },
            ch => char.ToUpperInvariant(ch));

        ZBase32 = new("ybndrfg8ejkmcpqxot1uwisza345h769", true,
            new Dictionary<char, int> { { '0', 16 }, { 'l', 18 }, { 'v', 19 }, { '2', 23 } },

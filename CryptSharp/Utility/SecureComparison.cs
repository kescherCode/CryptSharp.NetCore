...
public static class SecureComparison
{
    ...
    public static bool Equals(string? potentialAttackerSuppliedString, string? referenceString)
    {
        ...
        var attackLength = potentialAttackerSuppliedString!.Length;
        var referenceLength = referenceString.Length;

        var differences = attackLength ^ referenceLength;
        for (var i = 0; i < potentialAttackerSuppliedString.Length; i++)
        {

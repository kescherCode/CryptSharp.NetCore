...
public class CrypterOptions : IEnumerable<KeyValuePair<CrypterOptionKey, object>>
{
    ...
    static CrypterOptions() => None = new CrypterOptions().MakeReadOnly();
    ...
    public IEnumerator<KeyValuePair<CrypterOptionKey, object>> GetEnumerator() => _options.GetEnumerator();
    ...
    public T? GetValue<T>(CrypterOptionKey key) => GetValue<T>(key, default);

...
public partial class BaseEncoding : Encoding
{
        ...
        BaseEncodingDecodeFilterCallback? decodeFilterCallback)
    {
        ...
        _values = additionalDecodeCharacters is { }
            ? new(additionalDecodeCharacters)
    ...
    public virtual char GetChar(int value) => _characters[value & BitMask];
}
...
public abstract partial class Crypter
{
    ...
    /// </summary>
    public virtual CrypterOptions Properties => CrypterOptions.None;
    ...
    public static bool CheckPassword(string password, string cryptedPassword) =>
        CrypterEnvironment.Default.CheckPassword(password, cryptedPassword);
    ...
    public static Crypter? GetCrypter(string cryptedPassword) => CrypterEnvironment.Default.GetCrypter(cryptedPassword);
    ...
    public string Crypt(string password) => Crypt(password, GenerateSalt());
    ...
    /// <returns>The crypted password.</returns>
    public string Crypt(string password, CrypterOptions options) => Crypt(password, GenerateSalt(options));
    ...
    /// <returns>The crypted password.</returns>
    public string Crypt(byte[] password) => Crypt(password, GenerateSalt());
    ...
    public string GenerateSalt() => GenerateSalt(CrypterOptions.None);
    ...
    public string GenerateSalt(int rounds)
    {
        ...
        return GenerateSalt(new CrypterOptions { { CrypterOption.Rounds, rounds } });
    }

...
using System;
using CryptSharp.NetCore.Demo.BaseEncoding;

namespace CryptSharp.NetCore.Demo;
...
internal class MainClass
{
    public static void Main(string[] args)
    {
        ...
        var crypt = Crypter.Blowfish.GenerateSalt();
        ...
        Console.WriteLine("The password HelloWorld crypts to: {0}",
            Crypter.MD5.Crypt("HelloWorld",
                new CrypterOptions { { CrypterOption.Variant, MD5CrypterVariant.Apache } }));

        Console.WriteLine();

        Console.WriteLine("WordPress uses portable PHPass passwords.");
        var wpPassword = Crypter.Phpass.Crypt("HelloWorld");
        ...
        Console.WriteLine("It is {0} that the password is OpenSesame.",
            Crypter.CheckPassword("OpenSesame", wpPassword));

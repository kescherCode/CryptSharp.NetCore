...
namespace CryptSharp.NetCore.Demo.BaseEncoding;
...
internal static class TestVectors
{
    ...
    private static void TestConversion(Encoding encoding, byte[] testBytes, string expectedString)
    {
        ...
        var actualString = encoding.GetString(testBytes);
        ...
        var roundtripBytes = encoding.GetBytes(actualString);
    ...
    private static void TestDone() => Console.WriteLine("done.");
}